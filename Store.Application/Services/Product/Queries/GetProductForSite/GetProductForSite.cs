...
namespace Store.Application.Services.Product.Queries.GetProductForSite
{
    public class GetProductForSiteService : IGetProductForSite
    {
        ...
        public ResultDto<ResultProductForSiteDto> Execute(Ordering ordering, string SearchKey, int Page, int pageSize, long? CatId)
        {
            ...
            var product = productQuery.ToPage(Page, pageSize, out totalRow);

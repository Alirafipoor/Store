...
using Store.Models.ViewModels.AuthenticationViewModels;
...
namespace Store.Controllers
{
    public class Authentication : Controller
    {
        ...
        public Authentication(IRegisterUserService registerUserService, IUserLoginService userLoginService)
        {
